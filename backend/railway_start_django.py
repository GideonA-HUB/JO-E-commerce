#!/usr/bin/env python
"""
Django Railway startup script for TASTY FINGERS
Uses Django's built-in server to avoid Gunicorn issues
"""
import os
import sys
...
def start_server():
    ...
    # Start Django with Railway's port
    cmd = "python manage.py runserver 0.0.0.0:$PORT"
    print(f"Running: {cmd}")
    os.system(cmd)

if __name__ == '__main__':
    print("🚀 Starting TASTY FINGERS on Railway (Django Mode)...")
    print("=" * 60)
